...
data = dict(
    ...
    val=dict(
        type='PCCRDataset',
        data_root='data/pccr/R1/',
        ann_file='data/pccr/R1/R1_infos_val.pkl',
        pipeline=[
            dict(type='LoadMultiViewImageFromFiles', to_float32=True),
            dict(
                type='ResizeCropFlipImage',
    ...
    test=dict(
        type='PCCRDataset',
        data_root='data/pccr/R1/',
        ann_file='data/pccr/R1/R1_infos_test.pkl',
        pipeline=[
            dict(type='LoadMultiViewImageFromFiles', to_float32=True),
            dict(
                type='ResizeCropFlipImage',
...
log_level = 'INFO'
work_dir = './results/petr_r50dcn_gridmask_p4_800x320_pccr/R1'
load_from = None
resume_from = None
workflow = [('train', 1)]
plugin = True
...
ida_aug_conf = dict(
    ...
    W=1280,
    rand_flip=True)
train_ann_file = 'data/pccr/R1/R1_infos_train.pkl'
val_ann_file = 'data/pccr/R1/R1_infos_val.pkl'
test_ann_file = 'data/pccr/R1/R1_infos_test.pkl'
optimizer = dict(
    type='AdamW',
    lr=0.0002,
